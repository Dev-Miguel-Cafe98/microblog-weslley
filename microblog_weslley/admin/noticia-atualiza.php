...
//Capturando o tipo de usuário que está logado
...
if (isset($_POST['atualizar'])) {
    ...
    /*Se o campo "imagem" estiver vazio, entao significa que o usuário NAO QUER MUDAR DE IMAGEM.Portanto, a imagem que ja existe continuará (será matida) */
    if (empty($_FILES['imagem']['name'])) {
        //Pegamos a imagem/referencia que ja tem e colocamos na variável
